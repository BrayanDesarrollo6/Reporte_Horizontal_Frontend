...
@Component({
  selector: 'app-reporte-dhl',
  templateUrl: './reporte-dhl.component.html',
  styleUrls: ['./reporte-dhl.component.css']
})
export class ReporteDHLComponent implements OnInit{
  ...
  // url_1 : string = 'http://localhost:4001/api/v1/reporteNominaDHL';
  // url_2 : string = 'http://localhost:4001/api/v1/reporteNominaDHL2';
  // url_3 : string = 'http://localhost:4001/api/v1/reporteNominaDHL3';
  // url_1 : string = 'http://164.92.109.128:4001/api/v1/reporteNominaDHL';
  // url_2 : string = 'http://164.92.109.128:4001/api/v1/reporteNominaDHL2';
  // url_3 : string = 'http://164.92.109.128:4001/api/v1/reporteNominaDHL3';
  url_1 : string = 'https://backcompensaciones.gestionhq5.com.co/api/v1/reporteNominaDHL';
  url_2 : string = 'https://backcompensaciones.gestionhq5.com.co/api/v1/reporteNominaDHL2';
  url_3 : string = 'https://backcompensaciones.gestionhq5.com.co/api/v1/reporteNominaDHL3';
  ...
  constructor(private reportservice: ReportService,  private formbuilder: FormBuilder, private dataservice: DataService, private title: Title){
    title.setTitle('Reporte especial DHL');
  }
